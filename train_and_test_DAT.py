...
from utils.utils_DAT import utils_DAT
...
def parse_args():
    ...
    parser.add_argument('--paradigm_name', type=str, default='DAT', help='the name of the paradigm')
...
if __name__ == '__main__':
    ...
    for source_domain, target_domain in domain_pairs:
        ...
        for num in range(number):
            ...
            trainer = utils_DAT(args, save_dir)
            trainer.setup()
