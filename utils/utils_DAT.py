...
class utils_DAT(object):
    ...
    def setup(self):
        ...
        # ---------------------------------------- Define the domain discriminator (DAT) -------------------------------
        self.max_iter = len(self.dataloaders['source_train']) * (args.max_epoch - args.middle_epoch)
        self.AdversarialNet = getattr(models, 'AdversarialNet')(in_feature=args.class_innum,
                ...
                for batch_idx, (inputs, labels) in enumerate(self.dataloaders[phase]):
                    ...
                    with torch.set_grad_enabled(phase == 'source_train'):
                        ...
                        if phase != 'source_train' or epoch < args.middle_epoch:
                            ...
                            loss = classifier_loss + 1.0 * adversarial_loss

                            loss_cla = classifier_loss
                            loss_dtl = adversarial_loss
