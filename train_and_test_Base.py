...
from utils.utils_Base import utils_Base
...
def parse_args():
    ...
    parser.add_argument('--paradigm_name', type=str, default='Base', help='the name of the paradigm')
...
if __name__ == '__main__':
    ...
    for source_domain, target_domain in domain_pairs:
        ...
        for num in range(number):
            ...
            trainer = utils_Base(args, save_dir)
